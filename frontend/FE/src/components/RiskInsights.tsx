...
export default function RiskInsights() {
  ...
  //     try {
  //       const response = await fetch('https://272-project.vercel.app/api/getMonthlyFraudStats'); // Adjust endpoint as necessary
  ...
  useEffect(() => {
    const fetchFraudData = async () => {
      try {
        const response = await fetch('https://272-project.vercel.app/api/getMonthlyFraudStats');
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchChartData = async () => {
      try {
        const response = await fetch('https://272-project.vercel.app/api/getMonthlyExpenseStats');
        const data = await response.json();
