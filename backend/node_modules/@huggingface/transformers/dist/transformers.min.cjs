...
/*!***********************!*\
  !*** ./src/models.js ***!
  \***********************/(e,t,n)=>{"use strict";n.r(t),n.d(t,{ASTForAudioClassification:()=>rn,ASTModel:()=>sn,ASTPreTrainedModel:()=>nn,AlbertForMaskedLM:()=>ht,AlbertForQuestionAnswering:()=>pt,AlbertForSequenceClassification:()=>ut,AlbertModel:()=>dt,AlbertPreTrainedModel:()=>ct,AutoModel:()=>qa,AutoModelForAudioClassification:()=>cl,AutoModelForAudioFrameClassification:()=>ul,AutoModelForCTC:()=>ll,AutoModelForCausalLM:()=>Ja,AutoModelForDepthEstimation:()=>ml,AutoModelForDocumentQuestionAnswering:()=>pl,AutoModelForImageClassification:()=>tl,AutoModelForImageFeatureExtraction:()=>gl,AutoModelForImageMatting:()=>hl,AutoModelForImageSegmentation:()=>nl,AutoModelForImageToImage:()=>_l,AutoModelForMaskGeneration:()=>al,AutoModelForMaskedLM:()=>Ka,AutoModelForNormalEstimation:()=>fl,AutoModelForObjectDetection:()=>ol,AutoModelForQuestionAnswering:()=>Za,AutoModelForSemanticSegmentation:()=>sl,AutoModelForSeq2SeqLM:()=>Xa,AutoModelForSequenceClassification:()=>Ua,AutoModelForSpeechSeq2Seq:()=>Qa,AutoModelForTextToSpectrogram:()=>Ha,AutoModelForTextToWaveform:()=>Ya,AutoModelForTokenClassification:()=>Wa,AutoModelForUniversalSegmentation:()=>rl,AutoModelForVision2Seq:()=>el,AutoModelForXVector:()=>dl,AutoModelForZeroShotObjectDetection:()=>il,BartForConditionalGeneration:()=>vt,BartForSequenceClassification:()=>Ft,BartModel:()=>Tt,BartPretrainedModel:()=>kt,BaseModelOutput:()=>U,BeitForImageClassification:()=>gr,BeitModel:()=>fr,BeitPreTrainedModel:()=>mr,BertForMaskedLM:()=>Q,BertForQuestionAnswering:()=>J,BertForSequenceClassification:()=>H,BertForTokenClassification:()=>Y,BertModel:()=>X,BertPreTrainedModel:()=>W,BlenderbotForConditionalGeneration:()=>It,BlenderbotModel:()=>zt,BlenderbotPreTrainedModel:()=>Lt,BlenderbotSmallForConditionalGeneration:()=>Ot,BlenderbotSmallModel:()=>Nt,BlenderbotSmallPreTrainedModel:()=>Bt,BloomForCausalLM:()=>Ls,BloomModel:()=>Es,BloomPreTrainedModel:()=>As,CLIPModel:()=>fn,CLIPPreTrainedModel:()=>mn,CLIPSegForImageSegmentation:()=>Sn,CLIPSegModel:()=>Pn,CLIPSegPreTrainedModel:()=>Cn,CLIPTextModel:()=>gn,CLIPTextModelWithProjection:()=>wn,CLIPVisionModel:()=>Mn,CLIPVisionModelWithProjection:()=>bn,CamembertForMaskedLM:()=>be,CamembertForQuestionAnswering:()=>ke,CamembertForSequenceClassification:()=>ye,CamembertForTokenClassification:()=>xe,CamembertModel:()=>Me,CamembertPreTrainedModel:()=>we,CausalLMOutput:()=>Tl,CausalLMOutputWithPast:()=>vl,ChineseCLIPModel:()=>Fn,ChineseCLIPPreTrainedModel:()=>vn,ClapAudioModelWithProjection:()=>zi,ClapModel:()=>Ei,ClapPreTrainedModel:()=>Ai,ClapTextModelWithProjection:()=>Li,CodeGenForCausalLM:()=>Yn,CodeGenModel:()=>Hn,CodeGenPreTrainedModel:()=>Qn,CohereForCausalLM:()=>us,CohereModel:()=>ds,CoherePreTrainedModel:()=>cs,ConvBertForMaskedLM:()=>le,ConvBertForQuestionAnswering:()=>ue,ConvBertForSequenceClassification:()=>ce,ConvBertForTokenClassification:()=>de,ConvBertModel:()=>ae,ConvBertPreTrainedModel:()=>ie,ConvNextForImageClassification:()=>mo,ConvNextModel:()=>_o,ConvNextPreTrainedModel:()=>ho,ConvNextV2ForImageClassification:()=>wo,ConvNextV2Model:()=>go,ConvNextV2PreTrainedModel:()=>fo,DPTForDepthEstimation:()=>Hr,DPTModel:()=>Qr,DPTPreTrainedModel:()=>Xr,DebertaForMaskedLM:()=>Fe,DebertaForQuestionAnswering:()=>Se,DebertaForSequenceClassification:()=>Ce,DebertaForTokenClassification:()=>Pe,DebertaModel:()=>ve,DebertaPreTrainedModel:()=>Te,DebertaV2ForMaskedLM:()=>Le,DebertaV2ForQuestionAnswering:()=>Be,DebertaV2ForSequenceClassification:()=>ze,DebertaV2ForTokenClassification:()=>Ie,DebertaV2Model:()=>Ee,DebertaV2PreTrainedModel:()=>Ae,DecisionTransformerModel:()=>ca,DecisionTransformerPreTrainedModel:()=>la,DeiTForImageClassification:()=>Ir,DeiTModel:()=>zr,DeiTPreTrainedModel:()=>Lr,DepthAnythingForDepthEstimation:()=>Jr,DepthAnythingPreTrainedModel:()=>Yr,DepthProForDepthEstimation:()=>so,DepthProPreTrainedModel:()=>no,DetrForObjectDetection:()=>br,DetrForSegmentation:()=>yr,DetrModel:()=>Mr,DetrObjectDetectionOutput:()=>xr,DetrPreTrainedModel:()=>wr,DetrSegmentationOutput:()=>kr,Dinov2ForImageClassification:()=>yo,Dinov2Model:()=>bo,Dinov2PreTrainedModel:()=>Mo,DistilBertForMaskedLM:()=>Re,DistilBertForQuestionAnswering:()=>Ve,DistilBertForSequenceClassification:()=>je,DistilBertForTokenClassification:()=>De,DistilBertModel:()=>Oe,DistilBertPreTrainedModel:()=>Ne,DonutSwinModel:()=>po,DonutSwinPreTrainedModel:()=>uo,EfficientNetForImageClassification:()=>Ui,EfficientNetModel:()=>qi,EfficientNetPreTrainedModel:()=>$i,ElectraForMaskedLM:()=>_e,ElectraForQuestionAnswering:()=>ge,ElectraForSequenceClassification:()=>me,ElectraForTokenClassification:()=>fe,ElectraModel:()=>he,ElectraPreTrainedModel:()=>pe,EsmForMaskedLM:()=>qe,EsmForSequenceClassification:()=>Ue,EsmForTokenClassification:()=>We,EsmModel:()=>$e,EsmPreTrainedModel:()=>Ge,FalconForCausalLM:()=>Si,FalconModel:()=>Pi,FalconPreTrainedModel:()=>Ci,FastViTForImageClassification:()=>er,FastViTModel:()=>Zs,FastViTPreTrainedModel:()=>Ks,Florence2ForConditionalGeneration:()=>_n,Florence2PreTrainedModel:()=>hn,GLPNForDepthEstimation:()=>co,GLPNModel:()=>lo,GLPNPreTrainedModel:()=>ao,GPT2LMHeadModel:()=>Ln,GPT2Model:()=>En,GPT2PreTrainedModel:()=>An,GPTBigCodeForCausalLM:()=>Xn,GPTBigCodeModel:()=>Wn,GPTBigCodePreTrainedModel:()=>Un,GPTJForCausalLM:()=>qn,GPTJModel:()=>$n,GPTJPreTrainedModel:()=>Gn,GPTNeoForCausalLM:()=>jn,GPTNeoModel:()=>On,GPTNeoPreTrainedModel:()=>Nn,GPTNeoXForCausalLM:()=>Rn,GPTNeoXModel:()=>Vn,GPTNeoXPreTrainedModel:()=>Dn,Gemma2ForCausalLM:()=>gs,Gemma2Model:()=>fs,Gemma2PreTrainedModel:()=>ms,GemmaForCausalLM:()=>_s,GemmaModel:()=>hs,GemmaPreTrainedModel:()=>ps,GraniteForCausalLM:()=>ls,GraniteModel:()=>as,GranitePreTrainedModel:()=>is,GroupViTModel:()=>Js,GroupViTPreTrainedModel:()=>Ys,HieraForImageClassification:()=>Or,HieraModel:()=>Nr,HieraPreTrainedModel:()=>Br,HubertForCTC:()=>ii,HubertForSequenceClassification:()=>ai,HubertModel:()=>oi,HubertPreTrainedModel:()=>ri,ImageMattingOutput:()=>Fl,JAISLMHeadModel:()=>Bn,JAISModel:()=>In,JAISPreTrainedModel:()=>zn,LlamaForCausalLM:()=>Zn,LlamaModel:()=>Kn,LlamaPreTrainedModel:()=>Jn,LlavaForConditionalGeneration:()=>un,LlavaPreTrainedModel:()=>dn,LongT5ForConditionalGeneration:()=>Mt,LongT5Model:()=>wt,LongT5PreTrainedModel:()=>gt,M2M100ForConditionalGeneration:()=>Io,M2M100Model:()=>zo,M2M100PreTrainedModel:()=>Lo,MBartForCausalLM:()=>Et,MBartForConditionalGeneration:()=>St,MBartForSequenceClassification:()=>At,MBartModel:()=>Pt,MBartPreTrainedModel:()=>Ct,MPNetForMaskedLM:()=>et,MPNetForQuestionAnswering:()=>st,MPNetForSequenceClassification:()=>tt,MPNetForTokenClassification:()=>nt,MPNetModel:()=>Ze,MPNetPreTrainedModel:()=>Ke,MT5ForConditionalGeneration:()=>xt,MT5Model:()=>yt,MT5PreTrainedModel:()=>bt,MarianMTModel:()=>Eo,MarianModel:()=>Ao,MarianPreTrainedModel:()=>So,MaskFormerForInstanceSegmentation:()=>io,MaskFormerModel:()=>oo,MaskFormerPreTrainedModel:()=>ro,MaskedLMOutput:()=>xl,MistralForCausalLM:()=>ki,MistralModel:()=>xi,MistralPreTrainedModel:()=>yi,MobileBertForMaskedLM:()=>He,MobileBertForQuestionAnswering:()=>Je,MobileBertForSequenceClassification:()=>Ye,MobileBertModel:()=>Qe,MobileBertPreTrainedModel:()=>Xe,MobileLLMForCausalLM:()=>ns,MobileLLMModel:()=>ts,MobileLLMPreTrainedModel:()=>es,MobileNetV1ForImageClassification:()=>Ki,MobileNetV1Model:()=>Ji,MobileNetV1PreTrainedModel:()=>Yi,MobileNetV2ForImageClassification:()=>ta,MobileNetV2Model:()=>ea,MobileNetV2PreTrainedModel:()=>Zi,MobileNetV3ForImageClassification:()=>ra,MobileNetV3Model:()=>sa,MobileNetV3PreTrainedModel:()=>na,MobileNetV4ForImageClassification:()=>aa,MobileNetV4Model:()=>ia,MobileNetV4PreTrainedModel:()=>oa,MobileViTForImageClassification:()=>or,MobileViTModel:()=>rr,MobileViTPreTrainedModel:()=>sr,MobileViTV2ForImageClassification:()=>lr,MobileViTV2Model:()=>ar,MobileViTV2PreTrainedModel:()=>ir,ModelOutput:()=>q,Moondream1ForConditionalGeneration:()=>pn,MptForCausalLM:()=>Bs,MptModel:()=>Is,MptPreTrainedModel:()=>zs,MusicgenForCausalLM:()=>Qi,MusicgenForConditionalGeneration:()=>Hi,MusicgenModel:()=>Xi,MusicgenPreTrainedModel:()=>Wi,NomicBertModel:()=>Z,NomicBertPreTrainedModel:()=>K,OPTForCausalLM:()=>js,OPTModel:()=>Os,OPTPreTrainedModel:()=>Ns,OlmoForCausalLM:()=>os,OlmoModel:()=>rs,OlmoPreTrainedModel:()=>ss,OpenELMForCausalLM:()=>bs,OpenELMModel:()=>Ms,OpenELMPreTrainedModel:()=>ws,OwlViTForObjectDetection:()=>ur,OwlViTModel:()=>dr,OwlViTPreTrainedModel:()=>cr,Owlv2ForObjectDetection:()=>_r,Owlv2Model:()=>hr,Owlv2PreTrainedModel:()=>pr,Phi3ForCausalLM:()=>Ss,Phi3Model:()=>Ps,Phi3PreTrainedModel:()=>Cs,PhiForCausalLM:()=>Fs,PhiModel:()=>vs,PhiPreTrainedModel:()=>Ts,PreTrainedModel:()=>$,PretrainedMixin:()=>da,PvtForImageClassification:()=>qs,PvtModel:()=>$s,PvtPreTrainedModel:()=>Gs,PyAnnoteForAudioFrameClassification:()=>Go,PyAnnoteModel:()=>Ro,PyAnnotePreTrainedModel:()=>Vo,QuestionAnsweringModelOutput:()=>kl,Qwen2ForCausalLM:()=>ks,Qwen2Model:()=>xs,Qwen2PreTrainedModel:()=>ys,RTDetrForObjectDetection:()=>Fr,RTDetrModel:()=>vr,RTDetrObjectDetectionOutput:()=>Cr,RTDetrPreTrainedModel:()=>Tr,ResNetForImageClassification:()=>Vr,ResNetModel:()=>Dr,ResNetPreTrainedModel:()=>jr,RoFormerForMaskedLM:()=>ne,RoFormerForQuestionAnswering:()=>oe,RoFormerForSequenceClassification:()=>se,RoFormerForTokenClassification:()=>re,RoFormerModel:()=>te,RoFormerPreTrainedModel:()=>ee,RobertaForMaskedLM:()=>Vt,RobertaForQuestionAnswering:()=>$t,RobertaForSequenceClassification:()=>Rt,RobertaForTokenClassification:()=>Gt,RobertaModel:()=>Dt,RobertaPreTrainedModel:()=>jt,SamImageSegmentationOutput:()=>Po,SamModel:()=>Co,SamPreTrainedModel:()=>Fo,SapiensForDepthEstimation:()=>eo,SapiensForNormalEstimation:()=>to,SapiensForSemanticSegmentation:()=>Zr,SapiensPreTrainedModel:()=>Kr,SegformerForImageClassification:()=>ji,SegformerForSemanticSegmentation:()=>Di,SegformerModel:()=>Oi,SegformerPreTrainedModel:()=>Ni,Seq2SeqLMOutput:()=>wl,SequenceClassifierOutput:()=>Ml,SiglipModel:()=>xn,SiglipPreTrainedModel:()=>yn,SiglipTextModel:()=>kn,SiglipVisionModel:()=>Tn,SpeechT5ForSpeechToText:()=>fi,SpeechT5ForTextToSpeech:()=>gi,SpeechT5HifiGan:()=>wi,SpeechT5Model:()=>mi,SpeechT5PreTrainedModel:()=>_i,SqueezeBertForMaskedLM:()=>it,SqueezeBertForQuestionAnswering:()=>lt,SqueezeBertForSequenceClassification:()=>at,SqueezeBertModel:()=>ot,SqueezeBertPreTrainedModel:()=>rt,StableLmForCausalLM:()=>Gi,StableLmModel:()=>Ri,StableLmPreTrainedModel:()=>Vi,Starcoder2ForCausalLM:()=>Fi,Starcoder2Model:()=>vi,Starcoder2PreTrainedModel:()=>Ti,Swin2SRForImageSuperResolution:()=>Wr,Swin2SRModel:()=>Ur,Swin2SRPreTrainedModel:()=>qr,SwinForImageClassification:()=>$r,SwinModel:()=>Gr,SwinPreTrainedModel:()=>Rr,T5ForConditionalGeneration:()=>ft,T5Model:()=>mt,T5PreTrainedModel:()=>_t,TableTransformerForObjectDetection:()=>Ar,TableTransformerModel:()=>Sr,TableTransformerObjectDetectionOutput:()=>Er,TableTransformerPreTrainedModel:()=>Pr,TokenClassifierOutput:()=>yl,TrOCRForCausalLM:()=>bi,TrOCRPreTrainedModel:()=>Mi,UniSpeechForCTC:()=>Xo,UniSpeechForSequenceClassification:()=>Qo,UniSpeechModel:()=>Wo,UniSpeechPreTrainedModel:()=>Uo,UniSpeechSatForAudioFrameClassification:()=>Zo,UniSpeechSatForCTC:()=>Jo,UniSpeechSatForSequenceClassification:()=>Ko,UniSpeechSatModel:()=>Yo,UniSpeechSatPreTrainedModel:()=>Ho,ViTForImageClassification:()=>Rs,ViTMAEModel:()=>Ws,ViTMAEPreTrainedModel:()=>Us,ViTMSNForImageClassification:()=>Hs,ViTMSNModel:()=>Qs,ViTMSNPreTrainedModel:()=>Xs,ViTModel:()=>Vs,ViTPreTrainedModel:()=>Ds,VisionEncoderDecoderModel:()=>cn,VitMatteForImageMatting:()=>nr,VitMattePreTrainedModel:()=>tr,VitsModel:()=>Bi,VitsModelOutput:()=>Cl,VitsPreTrainedModel:()=>Ii,Wav2Vec2BertForCTC:()=>ni,Wav2Vec2BertForSequenceClassification:()=>si,Wav2Vec2BertModel:()=>ti,Wav2Vec2BertPreTrainedModel:()=>ei,Wav2Vec2ForAudioFrameClassification:()=>Do,Wav2Vec2ForCTC:()=>Oo,Wav2Vec2ForSequenceClassification:()=>jo,Wav2Vec2Model:()=>No,Wav2Vec2PreTrainedModel:()=>Bo,WavLMForAudioFrameClassification:()=>hi,WavLMForCTC:()=>di,WavLMForSequenceClassification:()=>ui,WavLMForXVector:()=>pi,WavLMModel:()=>ci,WavLMPreTrainedModel:()=>li,WeSpeakerResNetModel:()=>qo,WeSpeakerResNetPreTrainedModel:()=>$o,WhisperForConditionalGeneration:()=>ln,WhisperModel:()=>an,WhisperPreTrainedModel:()=>on,XLMForQuestionAnswering:()=>Ht,XLMForSequenceClassification:()=>Xt,XLMForTokenClassification:()=>Qt,XLMModel:()=>Ut,XLMPreTrainedModel:()=>qt,XLMRobertaForMaskedLM:()=>Kt,XLMRobertaForQuestionAnswering:()=>tn,XLMRobertaForSequenceClassification:()=>Zt,XLMRobertaForTokenClassification:()=>en,XLMRobertaModel:()=>Jt,XLMRobertaPreTrainedModel:()=>Yt,XLMWithLMHeadModel:()=>Wt,XVectorOutput:()=>bl,YolosForObjectDetection:()=>To,YolosModel:()=>ko,YolosObjectDetectionOutput:()=>vo,YolosPreTrainedModel:()=>xo});var s=n(/*! ./configs.js */"./src/configs.js"),r=n(/*! ./backends/onnx.js */"./src/backends/onnx.js"),o=n(/*! ./utils/dtypes.js */"./src/utils/dtypes.js"),i=n(/*! ./utils/generic.js */"./src/utils/generic.js"),a=n(/*! ./utils/core.js */"./src/utils/core.js"),l=n(/*! ./utils/hub.js */"./src/utils/hub.js"),c=n(/*! ./utils/constants.js */"./src/utils/constants.js"),d=n(/*! ./generation/logits_process.js */"./src/generation/logits_process.js"),u=n(/*! ./generation/configuration_utils.js */"./src/generation/configuration_utils.js"),p=n(/*! ./utils/tensor.js */"./src/utils/tensor.js"),h=n(/*! ./utils/maths.js */"./src/utils/maths.js"),_=n(/*! ./generation/stopping_criteria.js */"./src/generation/stopping_criteria.js"),m=n(/*! ./generation/logits_sampler.js */"./src/generation/logits_sampler.js"),f=n(/*! ./env.js */"./src/env.js"),g=n(/*! ./models/whisper/generation_whisper.js */"./src/models/whisper/generation_whisper.js"),w=n(/*! ./models/whisper/common_whisper.js */"./src/models/whisper/common_whisper.js");const M=0,b=1,y=2,x=3,k=4,T=5,v=6,F=7,C=new Map,P=new Map,S=new Map;async function A(e,t,n){return Object.fromEntries(await Promise.all(Object.keys(t).map((async i=>{const{buffer:a,session_options:c,session_config:d}=await async function(e,t,n){const i=n.config?.["transformers.js_config"]??{};let a=n.device??i.device;a&&"string"!=typeof a&&(a.hasOwnProperty(t)?a=a[t]:(console.warn(`device not specified for "${t}". Using the default device.`),a=null));const c=a??(f.apis.IS_NODE_ENV?"cpu":"wasm"),d=(0,r.deviceToExecutionProviders)(c);let u=n.dtype??i.dtype;"string"!=typeof u&&(u&&u.hasOwnProperty(t)?u=u[t]:(u=o.DEFAULT_DEVICE_DTYPE_MAPPING[c]??o.DATA_TYPES.fp32,console.warn(`dtype not specified for "${t}". Using the default dtype (${u}) for this device (${c}).`)));const p=u;if(!o.DEFAULT_DTYPE_SUFFIX_MAPPING.hasOwnProperty(p))throw new Error(`Invalid dtype: ${p}. Should be one of: ${Object.keys(o.DATA_TYPES).join(", ")}`);if(p===o.DATA_TYPES.fp16&&"webgpu"===c&&!await(0,o.isWebGpuFp16Supported)())throw new Error(`The device (${c}) does not support fp16.`);const h=i.kv_cache_dtype?"string"==typeof i.kv_cache_dtype?i.kv_cache_dtype:i.kv_cache_dtype[p]??"float32":void 0;if(h&&!["float32","float16"].includes(h))throw new Error(`Invalid kv_cache_dtype: ${h}. Should be one of: float32, float16`);const _={dtype:p,kv_cache_dtype:h},m=o.DEFAULT_DTYPE_SUFFIX_MAPPING[p],g=`${n.subfolder??""}/${t}${m}.onnx`,w={...n.session_options};w.executionProviders??=d;const M=i.free_dimension_overrides;M?w.freeDimensionOverrides??=M:c.startsWith("webnn")&&!w.freeDimensionOverrides&&console.warn('WebNN does not currently support dynamic shapes and requires `free_dimension_overrides` to be set in config.json as a field within "transformers.js_config". When `free_dimension_overrides` is not set, you may experience significant performance degradation.');const b=(0,l.getModelFile)(e,g,!0,n),y=n.use_external_data_format??i.use_external_data_format;let x=[];if(y&&(!0===y||"object"==typeof y&&y.hasOwnProperty(t)&&!0===y[t])){if(f.apis.IS_NODE_ENV)throw new Error("External data format is not yet supported in Node.js");const s=`${t}${m}.onnx_data`,r=`${n.subfolder??""}/${s}`;x.push(new Promise((async(t,o)=>{const i=await(0,l.getModelFile)(e,r,!0,n);t({path:s,data:i})})))}else void 0!==w.externalData&&(x=w.externalData.map((async t=>{if("string"==typeof t.data){const s=await(0,l.getModelFile)(e,t.data,!0,n);return{...t,data:s}}return t})));if(x.length>0&&(w.externalData=await Promise.all(x)),"webgpu"===c){const e=(0,s.getKeyValueShapes)(n.config,{prefix:"present"});if(Object.keys(e).length>0&&!(0,r.isONNXProxy)()){const t={};for(const n in e)t[n]="gpu-buffer";w.preferredOutputLocation=t}}return{buffer:await b,session_options:w,session_config:_}}(e,t[i],n);return[i,await(0,r.createInferenceSession)(a,c,d)]}))))}async function E(e,t,n){return Object.fromEntries(await Promise.all(Object.keys(t).map((async s=>[s,await(0,l.getModelJSON)(e,t[s],!1,n)]))))}async function L(e,t){const n=function(e,t){const n=Object.create(null),s=[];for(const o of e.inputNames){const e=t[o];e instanceof p.Tensor?n[o]=(0,r.isONNXProxy)()?e.clone():e:s.push(o)}if(s.length>0)throw new Error(`An error occurred during model execution: "Missing the following inputs: ${s.join(", ")}.`);const o=Object.keys(t).length,i=e.inputNames.length;if(o>i){let n=Object.keys(t).filter((t=>!e.inputNames.includes(t)));console.warn(`WARNING: Too many inputs were provided (${o} > ${i}). The following inputs will be ignored: "${n.join(", ")}".`)}return n}(e,t);try{const t=Object.fromEntries(Object.entries(n).map((([e,t])=>[e,t.ort_tensor])));let s=await e.run(t);return s=z(s),s}catch(e){throw console.error(`An error occurred during model execution: "${e}".`),console.error("Inputs given to model:",n),e}}function z(e){for(let t in e)(0,r.isONNXTensor)(e[t])?e[t]=new p.Tensor(e[t]):"object"==typeof e[t]&&z(e[t]);return e}function I(e){if(e instanceof p.Tensor)return e;if(0===e.length)throw Error("items must be non-empty");if(Array.isArray(e[0])){if(e.some((t=>t.length!==e[0].length)))throw Error("Unable to create tensor, you should probably activate truncation and/or padding with 'padding=True' and/or 'truncation=True' to have batched tensors with the same length.");return new p.Tensor("int64",BigInt64Array.from(e.flat().map((e=>BigInt(e)))),[e.length,e[0].length])}return new p.Tensor("int64",BigInt64Array.from(e.map((e=>BigInt(e)))),[1,e.length])}function B(e){return new p.Tensor("bool",[e],[1])}async function N(e,t){let{encoder_outputs:n,input_ids:s,decoder_input_ids:r,...o}=t;if(!n){const s=(0,a.pick)(t,e.sessions.model.inputNames);n=(await O(e,s)).last_hidden_state}o.input_ids=r,o.encoder_hidden_states=n,e.sessions.decoder_model_merged.inputNames.includes("encoder_attention_mask")&&(o.encoder_attention_mask=t.attention_mask);return await j(e,o,!0)}async function O(e,t){const n=e.sessions.model,s=(0,a.pick)(t,n.inputNames);if(n.inputNames.includes("inputs_embeds")&&!s.inputs_embeds){if(!t.input_ids)throw new Error("Both `input_ids` and `inputs_embeds` are missing in the model inputs.");s.inputs_embeds=await e.encode_text({input_ids:t.input_ids})}return n.inputNames.includes("token_type_ids")&&!s.token_type_ids&&(s.token_type_ids=new p.Tensor("int64",new BigInt64Array(s.input_ids.data.length),s.input_ids.dims)),await L(n,s)}async function j(e,t,n=!1){const s=e.sessions[n?"decoder_model_merged":"model"],{past_key_values:r,...o}=t;s.inputNames.includes("use_cache_branch")&&(o.use_cache_branch=B(!!r)),s.inputNames.includes("position_ids")&&o.attention_mask&&!o.position_ids&&(o.position_ids=function(e,t=null){const{input_ids:n,inputs_embeds:s,attention_mask:r}=e,[o,i]=r.dims,a=new BigInt64Array(r.data.length);for(let e=0;e<o;++e){const t=e*i;let n=BigInt(0);for(let e=0;e<i;++e){const s=t+e;0n===r.data[s]?a[s]=BigInt(1):(a[s]=n,n+=r.data[s])}}let l=new p.Tensor("int64",a,r.dims);if(t){const e=-(n??s).dims.at(1);l=l.slice(null,[e,null])}return l}(o,r)),e.addPastKeyValues(o,r);const i=(0,a.pick)(o,s.inputNames);return await L(s,i)}async function D(e,{input_ids:t=null,attention_mask:n=null,pixel_values:s=null,position_ids:r=null,inputs_embeds:o=null,past_key_values:i=null,generation_config:a=null,logits_processor:l=null,...c}){if(!o)if(o=await e.encode_text({input_ids:t}),s&&1!==t.dims[1]){const r=await e.encode_image({pixel_values:s});({inputs_embeds:o,attention_mask:n}=e._merge_input_ids_with_image_features({image_features:r,inputs_embeds:o,input_ids:t,attention_mask:n}))}else if(i&&s&&1===t.dims[1]){const e=t.dims[1],s=Object.values(i)[0].dims.at(-2);n=(0,p.cat)([(0,p.ones)([t.dims[0],s]),n.slice(null,[n.dims[1]-e,n.dims[1]])],1)}return await j(e,{inputs_embeds:o,past_key_values:i,attention_mask:n,position_ids:r,generation_config:a,logits_processor:l},!0)}function V(e,t,n,s){if(n.past_key_values){const t=Object.values(n.past_key_values)[0].dims.at(-2),{input_ids:s,attention_mask:r}=n;if(r&&r.dims[1]>s.dims[1]);else if(t<s.dims[1])n.input_ids=s.slice(null,[t,null]);else if(null!=e.config.image_token_index&&s.data.some((t=>t==e.config.image_token_index))){const r=e.config.num_image_tokens;if(!r)throw new Error("`num_image_tokens` is missing in the model configuration.");const o=s.dims[1]-(t-r);n.input_ids=s.slice(null,[-o,null]),n.attention_mask=(0,p.ones)([1,t+o])}}return n}function R(e,t,n,s){return n.past_key_values&&(t=t.map((e=>[e.at(-1)]))),{...n,decoder_input_ids:I(t)}}function G(e,...t){return e.config.is_encoder_decoder?R(e,...t):V(e,...t)}class $ extends i.Callable{main_input_name="input_ids";forward_params=["input_ids","attention_mask"];constructor(e,t,n){super(),this.config=e,this.sessions=t,this.configs=n;const s=S.get(this.constructor),r=C.get(s);switch(this.can_generate=!1,this._forward=null,this._prepare_inputs_for_generation=null,r){case k:this.can_generate=!0,this._forward=j,this._prepare_inputs_for_generation=V;break;case y:case x:case F:this.can_generate=!0,this._forward=N,this._prepare_inputs_for_generation=R;break;case b:this._forward=N;break;case v:this.can_generate=!0,this._forward=D,this._prepare_inputs_for_generation=G;break;default:this._forward=O}this.can_generate&&this.forward_params.push("past_key_values"),this.custom_config=this.config["transformers.js_config"]??{}}async dispose(){const e=[];for(const t of Object.values(this.sessions))t?.handler?.dispose&&e.push(t.handler.dispose());return await Promise.all(e)}static async from_pretrained(e,{progress_callback:t=null,config:n=null,cache_dir:r=null,local_files_only:o=!1,revision:i="main",model_file_name:a=null,subfolder:l="onnx",device:d=null,dtype:u=null,use_external_data_format:p=null,session_options:h={}}={}){let _={progress_callback:t,config:n,cache_dir:r,local_files_only:o,revision:i,model_file_name:a,subfolder:l,device:d,dtype:u,use_external_data_format:p,session_options:h};const m=S.get(this),f=C.get(m);let g;if(n=_.config=await s.AutoConfig.from_pretrained(e,_),f===k)g=await Promise.all([A(e,{model:_.model_file_name??"model"},_),E(e,{generation_config:"generation_config.json"},_)]);else if(f===y||f===x)g=await Promise.all([A(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},_),E(e,{generation_config:"generation_config.json"},_)]);else if(f===T)g=await Promise.all([A(e,{model:"vision_encoder",prompt_encoder_mask_decoder:"prompt_encoder_mask_decoder"},_)]);else if(f===b)g=await Promise.all([A(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},_)]);else if(f===v){const t={embed_tokens:"embed_tokens",vision_encoder:"vision_encoder",decoder_model_merged:"decoder_model_merged"};n.is_encoder_decoder&&(t.model="encoder_model"),g=await Promise.all([A(e,t,_),E(e,{generation_config:"generation_config.json"},_)])}else f===F?g=await Promise.all([A(e,{model:"text_encoder",decoder_model_merged:"decoder_model_merged",encodec_decode:"encodec_decode"},_),E(e,{generation_config:"generation_config.json"},_)]):(f!==M&&console.warn(`Model type for '${m??n?.model_type}' not found, assuming encoder-only architecture. Please report this at ${c.GITHUB_ISSUE_URL}.`),g=await Promise.all([A(e,{model:_.model_file_name??"model"},_)]));return new this(n,...g)}async _call(e){return await this.forward(e)}async forward(e){return await this._forward(this,e)}get generation_config(){return this.configs?.generation_config??null}_get_logits_warper(e){const t=new d.LogitsProcessorList;return null!==e.temperature&&1!==e.temperature&&t.push(new d.TemperatureLogitsWarper(e.temperature)),null!==e.top_k&&0!==e.top_k&&t.push(new d.TopKLogitsWarper(e.top_k)),null!==e.top_p&&e.top_p<1&&t.push(new d.TopPLogitsWarper(e.top_p)),t}_get_logits_processor(e,t,n=null){const s=new d.LogitsProcessorList;if(null!==e.repetition_penalty&&1!==e.repetition_penalty&&s.push(new d.RepetitionPenaltyLogitsProcessor(e.repetition_penalty)),null!==e.no_repeat_ngram_size&&e.no_repeat_ngram_size>0&&s.push(new d.NoRepeatNGramLogitsProcessor(e.no_repeat_ngram_size)),null!==e.bad_words_ids&&s.push(new d.NoBadWordsLogitsProcessor(e.bad_words_ids,e.eos_token_id)),null!==e.min_length&&null!==e.eos_token_id&&e.min_length>0&&s.push(new d.MinLengthLogitsProcessor(e.min_length,e.eos_token_id)),null!==e.min_new_tokens&&null!==e.eos_token_id&&e.min_new_tokens>0&&s.push(new d.MinNewTokensLengthLogitsProcessor(t,e.min_new_tokens,e.eos_token_id)),null!==e.forced_bos_token_id&&s.push(new d.ForcedBOSTokenLogitsProcessor(e.forced_bos_token_id)),null!==e.forced_eos_token_id&&s.push(new d.ForcedEOSTokenLogitsProcessor(e.max_length,e.forced_eos_token_id)),null!==e.begin_suppress_tokens){const n=t>1||null===e.forced_bos_token_id?t:t+1;s.push(new d.SuppressTokensAtBeginLogitsProcessor(e.begin_suppress_tokens,n))}return null!==e.guidance_scale&&e.guidance_scale>1&&s.push(new d.ClassifierFreeGuidanceLogitsProcessor(e.guidance_scale)),null!==n&&s.extend(n),s}_prepare_generation_config(e,t,n=u.GenerationConfig){const s={...this.config};for(const e of["decoder","generator","text_config"])e in s&&Object.assign(s,s[e]);const r=new n(s);return Object.assign(r,this.generation_config??{}),e&&Object.assign(r,e),t&&Object.assign(r,(0,a.pick)(t,Object.getOwnPropertyNames(r))),r}_get_stopping_criteria(e,t=null){const n=new _.StoppingCriteriaList;return null!==e.max_length&&n.push(new _.MaxLengthCriteria(e.max_length,this.config.max_position_embeddings??null)),null!==e.eos_token_id&&n.push(new _.EosTokenCriteria(e.eos_token_id)),t&&n.extend(t),n}_validate_model_class(){if(!this.can_generate){const e=[ba,ka,Ma,_a],t=S.get(this.constructor),n=new Set,s=this.config.model_type;for(const t of e){const e=t.get(s);e&&n.add(e[0])}let r=`The current model class (${t}) is not compatible with \`.generate()\`, as it doesn't have a language model head.`;throw n.size>0&&(r+=` Please use the following class instead: ${[...n].join(", ")}`),Error(r)}}prepare_inputs_for_generation(...e){return this._prepare_inputs_for_generation(this,...e)}_update_model_kwargs_for_generation({generated_input_ids:e,outputs:t,model_inputs:n,is_encoder_decoder:s}){return n.past_key_values=this.getPastKeyValues(t,n.past_key_values),n.input_ids=new p.Tensor("int64",e.flat(),[e.length,1]),s||(n.attention_mask=(0,p.cat)([n.attention_mask,(0,p.ones)([n.attention_mask.dims[0],1])],1)),n.position_ids=null,n}_prepare_model_inputs({inputs:e,bos_token_id:t,model_kwargs:n}){const s=(0,a.pick)(n,this.forward_params),r=this.main_input_name;if(r in s){if(e)throw new Error("`inputs`: {inputs}` were passed alongside {input_name} which is not allowed. Make sure to either pass {inputs} or {input_name}=...")}else s[r]=e;return{inputs_tensor:s[r],model_inputs:s,model_input_name:r}}async _prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:e,model_inputs:t,model_input_name:n,generation_config:s}){if(this.sessions.model.inputNames.includes("inputs_embeds")&&!t.inputs_embeds&&"_prepare_inputs_embeds"in this){const{input_ids:e,pixel_values:n,attention_mask:s,...r}=t,o=await this._prepare_inputs_embeds(t);t={...r,...(0,a.pick)(o,["inputs_embeds","attention_mask"])}}let{last_hidden_state:r}=await O(this,t);if(null!==s.guidance_scale&&s.guidance_scale>1)r=(0,p.cat)([r,(0,p.full_like)(r,0)],0),"attention_mask"in t&&(t.attention_mask=(0,p.cat)([t.attention_mask,(0,p.zeros_like)(t.attention_mask)],0));else if(t.decoder_input_ids){const e=I(t.decoder_input_ids).dims[0];if(e!==r.dims[0]){if(1!==r.dims[0])throw new Error(`The encoder outputs have a different batch size (${r.dims[0]}) than the decoder inputs (${e}).`);r=(0,p.cat)(Array.from({length:e},(()=>r)),0)}}return t.encoder_outputs=r,t}_prepare_decoder_input_ids_for_generation({batch_size:e,model_input_name:t,model_kwargs:n,decoder_start_token_id:s,bos_token_id:r,generation_config:o}){let{decoder_input_ids:i,...a}=n;if(!(i instanceof p.Tensor)){if(i)Array.isArray(i[0])||(i=Array.from({length:e},(()=>i)));else if(s??=r,"musicgen"===this.config.model_type)i=Array.from({length:e*this.config.decoder.num_codebooks},(()=>[s]));else if(Array.isArray(s)){if(s.length!==e)throw new Error(`\`decoder_start_token_id\` expcted to have length ${e} but got ${s.length}`);i=s}else i=Array.from({length:e},(()=>[s]));i=I(i)}return n.decoder_attention_mask=(0,p.ones_like)(i),{input_ids:i,model_inputs:a}}async generate({inputs:e=null,generation_config:t=null,logits_processor:n=null,stopping_criteria:s=null,streamer:r=null,...o}){this._validate_model_class(),t=this._prepare_generation_config(t,o);let{inputs_tensor:i,model_inputs:a,model_input_name:l}=this._prepare_model_inputs({inputs:e,model_kwargs:o});const c=this.config.is_encoder_decoder;let d;c&&("encoder_outputs"in a||(a=await this._prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:i,model_inputs:a,model_input_name:l,generation_config:t}))),c?({input_ids:d,model_inputs:a}=this._prepare_decoder_input_ids_for_generation({batch_size:a[l].dims.at(0),model_input_name:l,model_kwargs:a,decoder_start_token_id:t.decoder_start_token_id,bos_token_id:t.bos_token_id,generation_config:t})):d=a[l];let u=d.dims.at(-1);null!==t.max_new_tokens&&(t.max_length=u+t.max_new_tokens);const h=this._get_logits_processor(t,u,n),_=this._get_stopping_criteria(t,s),f=a[l].dims.at(0),g=m.LogitsSampler.getSampler(t),w=new Array(f).fill(0),M=d.tolist();let b;r&&r.put(M);let y={};for(;;){if(a=this.prepare_inputs_for_generation(M,a,t),b=await this.forward(a),t.output_attentions&&t.return_dict_in_generate){const e=this.getAttentions(b);for(const t in e)t in y||(y[t]=[]),y[t].push(e[t])}const e=h(M,b.logits.slice(null,-1,null)),n=[];for(let t=0;t<e.dims.at(0);++t){const s=e[t],r=await g(s);for(const[e,s]of r){const r=BigInt(e);w[t]+=s,M[t].push(r),n.push([r]);break}}r&&r.put(n);if(_(M).every((e=>e)))break;a=this._update_model_kwargs_for_generation({generated_input_ids:n,outputs:b,model_inputs:a,is_encoder_decoder:c})}r&&r.end();const x=this.getPastKeyValues(b,a.past_key_values,!0),k=new p.Tensor("int64",M.flat(),[M.length,M[0].length]);if(t.return_dict_in_generate)return{sequences:k,past_key_values:x,...y};for(const e of Object.values(b))"gpu-buffer"===e.location&&e.dispose();return k}getPastKeyValues(e,t,n=!1){const s=Object.create(null);for(const r in e)if(r.startsWith("present")){const o=r.replace("present","past_key_values"),i=r.includes("encoder");if(s[o]=i&&t?t[o]:e[r],t&&(!i||n)){const e=t[o];"gpu-buffer"===e.location&&e.dispose()}}return s}getAttentions(e){const t={};for(const n of["cross_attentions","encoder_attentions","decoder_attentions"])for(const s in e)s.startsWith(n)&&(n in t||(t[n]=[]),t[n].push(e[s]));return t}addPastKeyValues(e,t){if(t)Object.assign(e,t);else{const t=this.sessions.decoder_model_merged??this.sessions.model,n=t?.config?.kv_cache_dtype??"float32",r="float16"===n?new Uint16Array:[],o=(0,s.getKeyValueShapes)(this.config);for(const t in o)e[t]=new p.Tensor(n,r,o[t])}}async encode_image({pixel_values:e}){const t=(await L(this.sessions.vision_encoder,{pixel_values:e})).image_features;return this.config.num_image_tokens||(console.warn(`The number of image tokens was not set in the model configuration. Setting it to the number of features detected by the vision encoder (${t.dims[1]}).`),this.config.num_image_tokens=t.dims[1]),t}async encode_text({input_ids:e}){return(await L(this.sessions.embed_tokens,{input_ids:e})).inputs_embeds}}class q{}class U extends q{constructor({last_hidden_state:e,hidden_states:t=null,attentions:n=null}){super(),this.last_hidden_state=e,this.hidden_states=t,this.attentions=n}}class W extends ${}class X extends W{}class Q extends W{async _call(e){return new xl(await super._call(e))}}class H extends W{async _call(e){return new Ml(await super._call(e))}}class Y extends W{async _call(e){return new yl(await super._call(e))}}class J extends W{async _call(e){return new kl(await super._call(e))}}class K extends ${}class Z extends K{}class ee extends ${}class te extends ee{}class ne extends ee{async _call(e){return new xl(await super._call(e))}}class se extends ee{async _call(e){return new Ml(await super._call(e))}}class re extends ee{async _call(e){return new yl(await super._call(e))}}class oe extends ee{async _call(e){return new kl(await super._call(e))}}class ie extends ${}class ae extends ie{}class le extends ie{async _call(e){return new xl(await super._call(e))}}class ce extends ie{async _call(e){return new Ml(await super._call(e))}}class de extends ie{async _call(e){return new yl(await super._call(e))}}class ue extends ie{async _call(e){return new kl(await super._call(e))}}class pe extends ${}class he extends pe{}class _e extends pe{async _call(e){return new xl(await super._call(e))}}class me extends pe{async _call(e){return new Ml(await super._call(e))}}class fe extends pe{async _call(e){return new yl(await super._call(e))}}class ge extends pe{async _call(e){return new kl(await super._call(e))}}class we extends ${}class Me extends we{}class be extends we{async _call(e){return new xl(await super._call(e))}}class ye extends we{async _call(e){return new Ml(await super._call(e))}}class xe extends we{async _call(e){return new yl(await super._call(e))}}class ke extends we{async _call(e){return new kl(await super._call(e))}}class Te extends ${}class ve extends Te{}class Fe extends Te{async _call(e){return new xl(await super._call(e))}}class Ce extends Te{async _call(e){return new Ml(await super._call(e))}}class Pe extends Te{async _call(e){return new yl(await super._call(e))}}class Se extends Te{async _call(e){return new kl(await super._call(e))}}class Ae extends ${}class Ee extends Ae{}class Le extends Ae{async _call(e){return new xl(await super._call(e))}}class ze extends Ae{async _call(e){return new Ml(await super._call(e))}}class Ie extends Ae{async _call(e){return new yl(await super._call(e))}}class Be extends Ae{async _call(e){return new kl(await super._call(e))}}class Ne extends ${}class Oe extends Ne{}class je extends Ne{async _call(e){return new Ml(await super._call(e))}}class De extends Ne{async _call(e){return new yl(await super._call(e))}}class Ve extends Ne{async _call(e){return new kl(await super._call(e))}}class Re extends Ne{async _call(e){return new xl(await super._call(e))}}class Ge extends ${}class $e extends Ge{}class qe extends Ge{async _call(e){return new xl(await super._call(e))}}class Ue extends Ge{async _call(e){return new Ml(await super._call(e))}}class We extends Ge{async _call(e){return new yl(await super._call(e))}}class Xe extends ${}class Qe extends Xe{}class He extends Xe{async _call(e){return new xl(await super._call(e))}}class Ye extends Xe{async _call(e){return new Ml(await super._call(e))}}class Je extends Xe{async _call(e){return new kl(await super._call(e))}}class Ke extends ${}class Ze extends Ke{}class et extends Ke{async _call(e){return new xl(await super._call(e))}}class tt extends Ke{async _call(e){return new Ml(await super._call(e))}}class nt extends Ke{async _call(e){return new yl(await super._call(e))}}class st extends Ke{async _call(e){return new kl(await super._call(e))}}class rt extends ${}class ot extends rt{}class it extends rt{async _call(e){return new xl(await super._call(e))}}class at extends rt{async _call(e){return new Ml(await super._call(e))}}class lt extends rt{async _call(e){return new kl(await super._call(e))}}class ct extends ${}class dt extends ct{}class ut extends ct{async _call(e){return new Ml(await super._call(e))}}class pt extends ct{async _call(e){return new kl(await super._call(e))}}class ht extends ct{async _call(e){return new xl(await super._call(e))}}class _t extends ${forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"]}class mt extends _t{}class ft extends _t{}class gt extends ${}class wt extends gt{}class Mt extends gt{}class bt extends ${}class yt extends bt{}class xt extends bt{}class kt extends ${}class Tt extends kt{}class vt extends kt{}class Ft extends kt{async _call(e){return new Ml(await super._call(e))}}class Ct extends ${}class Pt extends Ct{}class St extends Ct{}class At extends Ct{async _call(e){return new Ml(await super._call(e))}}class Et extends Ct{}class Lt extends ${}class zt extends Lt{}class It extends Lt{}class Bt extends ${}class Nt extends Bt{}class Ot extends Bt{}class jt extends ${}class Dt extends jt{}class Vt extends jt{async _call(e){return new xl(await super._call(e))}}class Rt extends jt{async _call(e){return new Ml(await super._call(e))}}class Gt extends jt{async _call(e){return new yl(await super._call(e))}}class $t extends jt{async _call(e){return new kl(await super._call(e))}}class qt extends ${}class Ut extends qt{}class Wt extends qt{async _call(e){return new xl(await super._call(e))}}class Xt extends qt{async _call(e){return new Ml(await super._call(e))}}class Qt extends qt{async _call(e){return new yl(await super._call(e))}}class Ht extends qt{async _call(e){return new kl(await super._call(e))}}class Yt extends ${}class Jt extends Yt{}class Kt extends Yt{async _call(e){return new xl(await super._call(e))}}class Zt extends Yt{async _call(e){return new Ml(await super._call(e))}}class en extends Yt{async _call(e){return new yl(await super._call(e))}}class tn extends Yt{async _call(e){return new kl(await super._call(e))}}class nn extends ${}class sn extends nn{}class rn extends nn{}class on extends ${requires_attention_mask=!1;main_input_name="input_features";forward_params=["input_features","attention_mask","decoder_input_ids","decoder_attention_mask","past_key_values"]}class an extends on{}class ln extends on{_prepare_generation_config(e,t){return super._prepare_generation_config(e,t,g.WhisperGenerationConfig)}_retrieve_init_tokens(e){const t=[e.decoder_start_token_id];let n=e.language;const s=e.task;if(e.is_multilingual){n||(console.warn("No language specified - defaulting to English (en)."),n="en");const r=`<|${(0,w.whisper_language_to_code)(n)}|>`;t.push(e.lang_to_id[r]),t.push(e.task_to_id[s??"transcribe"])}else if(n||s)throw new Error("Cannot specify `task` or `language` for an English-only model. If the model is intended to be multilingual, pass `is_multilingual=true` to generate, or update the generation config.");return!e.return_timestamps&&e.no_timestamps_token_id&&t.at(-1)!==e.no_timestamps_token_id?t.push(e.no_timestamps_token_id):e.return_timestamps&&t.at(-1)===e.no_timestamps_token_id&&(console.warn("<|notimestamps|> prompt token is removed from generation_config since `return_timestamps` is set to `true`."),t.pop()),t.filter((e=>null!=e))}async generate({inputs:e=null,generation_config:t=null,logits_processor:n=null,stopping_criteria:s=null,...r}){t=this._prepare_generation_config(t,r);const o=r.decoder_input_ids??this._retrieve_init_tokens(t);if(t.return_timestamps&&(n??=new d.LogitsProcessorList,n.push(new d.WhisperTimeStampLogitsProcessor(t,o))),t.begin_suppress_tokens&&(n??=new d.LogitsProcessorList,n.push(new d.SuppressTokensAtBeginLogitsProcessor(t.begin_suppress_tokens,o.length))),t.return_token_timestamps){if(!t.alignment_heads)throw new Error("Model generation config has no `alignment_heads`, token-level timestamps not available. See https://gist.github.com/hollance/42e32852f24243b748ae6bc1f985b13a on how to add this property to the generation config.");"translate"===t.task&&console.warn("Token-level timestamps may not be reliable for task 'translate'."),t.output_attentions=!0,t.return_dict_in_generate=!0}const i=await super.generate({inputs:e,generation_config:t,logits_processor:n,decoder_input_ids:o,...r});return t.return_token_timestamps&&(i.token_timestamps=this._extract_token_timestamps(i,t.alignment_heads,t.num_frames)),i}_extract_token_timestamps(e,t,n=null,s=.02){if(!e.cross_attentions)throw new Error("Model outputs must contain cross attentions to extract timestamps. This is most likely because the model was not exported with `output_attentions=True`.");null==n&&console.warn("`num_frames` has not been set, meaning the entire audio will be analyzed. This may lead to inaccurate token-level timestamps for short audios (< 30 seconds).");let r=this.config.median_filter_width;void 0===r&&(console.warn("Model config has no `median_filter_width`, using default value of 7."),r=7);const o=e.cross_attentions,i=Array.from({length:this.config.decoder_layers},((e,t)=>(0,p.cat)(o.map((e=>e[t])),2))),l=(0,p.stack)(t.map((([e,t])=>{if(e>=i.length)throw new Error(`Layer index ${e} is out of bounds for cross attentions (length ${i.length}).`);return n?i[e].slice(null,t,null,[0,n]):i[e].slice(null,t)}))).transpose(1,0,2,3),[c,d]=(0,p.std_mean)(l,-2,0,!0),u=l.clone();for(let e=0;e<u.dims[0];++e){const t=u[e];for(let n=0;n<t.dims[0];++n){const s=t[n],o=c[e][n][0].data,i=d[e][n][0].data;for(let e=0;e<s.dims[0];++e){let t=s[e].data;for(let e=0;e<t.length;++e)t[e]=(t[e]-i[e])/o[e];t.set((0,h.medianFilter)(t,r))}}}const _=[(0,p.mean)(u,1)],m=e.sequences.dims,f=new p.Tensor("float32",new Float32Array(m[0]*m[1]),m);for(let e=0;e<m[0];++e){const t=_[e].neg().squeeze_(0),[n,r]=(0,h.dynamic_time_warping)(t.tolist()),o=Array.from({length:n.length-1},((e,t)=>n[t+1]-n[t])),i=(0,a.mergeArrays)([1],o).map((e=>!!e)),l=[];for(let e=0;e<i.length;++e)i[e]&&l.push(r[e]*s);f[e].data.set(l,1)}return f}}class cn extends ${main_input_name="pixel_values";forward_params=["pixel_values","decoder_input_ids","encoder_hidden_states","past_key_values"]}class dn extends ${forward_params=["input_ids","pixel_values","attention_mask","position_ids","past_key_values"]}class un extends dn{_merge_input_ids_with_image_features({inputs_embeds:e,image_features:t,input_ids:n,attention_mask:s}){const r=this.config.image_token_index,o=n.tolist().map((e=>e.findIndex((e=>e==r)))),i=o.every((e=>-1===e)),a=o.every((e=>-1!==e));if(!i&&!a)throw new Error("Every input should contain either 0 or 1 image token.");if(i)return{inputs_embeds:e,attention_mask:s};const l=[],c=[];for(let n=0;n<o.length;++n){const r=o[n],i=e[n],a=t[n],d=s[n];l.push((0,p.cat)([i.slice([0,r]),a,i.slice([r+1,i.dims[0]])],0)),c.push((0,p.cat)([d.slice([0,r]),(0,p.ones)([a.dims[0]]),d.slice([r+1,d.dims[0]])],0))}return{inputs_embeds:(0,p.stack)(l,0),attention_mask:(0,p.stack)(c,0)}}}class pn extends un{}class hn extends ${forward_params=["input_ids","inputs_embeds","attention_mask","pixel_values","encoder_outputs","decoder_input_ids","decoder_inputs_embeds","decoder_attention_mask","past_key_values"];main_input_name="inputs_embeds"}class _n extends hn{_merge_input_ids_with_image_features({inputs_embeds:e,image_features:t,input_ids:n,attention_mask:s}){return{inputs_embeds:(0,p.cat)([t,e],1),attention_mask:(0,p.cat)([(0,p.ones)(t.dims.slice(0,2)),s],1)}}async _prepare_inputs_embeds({input_ids:e,pixel_values:t,inputs_embeds:n,attention_mask:s}){if(!e&&!t)throw new Error("Either `input_ids` or `pixel_values` should be provided.");let r,o;return e&&(r=await this.encode_text({input_ids:e})),t&&(o=await this.encode_image({pixel_values:t})),r&&o?({inputs_embeds:n,attention_mask:s}=this._merge_input_ids_with_image_features({inputs_embeds:r,image_features:o,input_ids:e,attention_mask:s})):n=r||o,{inputs_embeds:n,attention_mask:s}}async forward({input_ids:e,pixel_values:t,attention_mask:n,decoder_input_ids:s,decoder_attention_mask:r,encoder_outputs:o,past_key_values:i,inputs_embeds:a,decoder_inputs_embeds:l}){if(a||({inputs_embeds:a,attention_mask:n}=await this._prepare_inputs_embeds({input_ids:e,pixel_values:t,inputs_embeds:a,attention_mask:n})),!o){let{last_hidden_state:e}=await O(this,{inputs_embeds:a,attention_mask:n});o=e}if(!l){if(!s)throw new Error("Either `decoder_input_ids` or `decoder_inputs_embeds` should be provided.");l=await this.encode_text({input_ids:s})}const c={inputs_embeds:l,attention_mask:r,encoder_attention_mask:n,encoder_hidden_states:o,past_key_values:i};return await j(this,c,!0)}}class mn extends ${}class fn extends mn{}class gn extends mn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class wn extends mn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class Mn extends mn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class bn extends mn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class yn extends ${}class xn extends yn{}class kn extends yn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class Tn extends mn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class vn extends ${}class Fn extends vn{}class Cn extends ${}class Pn extends Cn{}class Sn extends Cn{}class An extends ${}class En extends An{}class Ln extends An{}class zn extends ${}class In extends zn{}class Bn extends zn{}class Nn extends ${}class On extends Nn{}class jn extends Nn{}class Dn extends ${}class Vn extends Dn{}class Rn extends Dn{}class Gn extends ${}class $n extends Gn{}class qn extends Gn{}class Un extends ${}class Wn extends Un{}class Xn extends Un{}class Qn extends ${}class Hn extends Qn{}class Yn extends Qn{}class Jn extends ${}class Kn extends Jn{}class Zn extends Jn{}class es extends ${}class ts extends es{}class ns extends es{}class ss extends ${}class rs extends ss{}class os extends ss{}class is extends ${}class as extends is{}class ls extends is{}class cs extends ${}class ds extends cs{}class us extends cs{}class ps extends ${}class hs extends ps{}class _s extends ps{}class ms extends ${}class fs extends ms{}class gs extends ms{}class ws extends ${}class Ms extends ws{}class bs extends ws{}class ys extends ${}class xs extends ys{}class ks extends ys{}class Ts extends ${}class vs extends Ts{}class Fs extends Ts{}class Cs extends ${}class Ps extends Cs{}class Ss extends Cs{}class As extends ${}class Es extends As{}class Ls extends As{}class zs extends ${}class Is extends zs{}class Bs extends zs{}class Ns extends ${}class Os extends Ns{}class js extends Ns{}class Ds extends ${}class Vs extends Ds{}class Rs extends Ds{async _call(e){return new Ml(await super._call(e))}}class Gs extends ${}class $s extends Gs{}class qs extends Gs{async _call(e){return new Ml(await super._call(e))}}class Us extends ${}class Ws extends Us{}class Xs extends ${}class Qs extends Xs{}class Hs extends Xs{async _call(e){return new Ml(await super._call(e))}}class Ys extends ${}class Js extends Ys{}class Ks extends ${}class Zs extends Ks{}class er extends Ks{async _call(e){return new Ml(await super._call(e))}}class tr extends ${}class nr extends tr{async _call(e){return new Fl(await super._call(e))}}class sr extends ${}class rr extends sr{}class or extends sr{async _call(e){return new Ml(await super._call(e))}}class ir extends ${}class ar extends ir{}class lr extends ir{async _call(e){return new Ml(await super._call(e))}}class cr extends ${}class dr extends cr{}class ur extends cr{}class pr extends ${}class hr extends pr{}class _r extends pr{}class mr extends ${}class fr extends mr{}class gr extends mr{async _call(e){return new Ml(await super._call(e))}}class wr extends ${}class Mr extends wr{}class br extends wr{async _call(e){return new xr(await super._call(e))}}class yr extends wr{async _call(e){return new kr(await super._call(e))}}class xr extends q{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class kr extends q{constructor({logits:e,pred_boxes:t,pred_masks:n}){super(),this.logits=e,this.pred_boxes=t,this.pred_masks=n}}class Tr extends ${}class vr extends Tr{}class Fr extends Tr{async _call(e){return new Cr(await super._call(e))}}class Cr extends q{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class Pr extends ${}class Sr extends Pr{}class Ar extends Pr{async _call(e){return new Er(await super._call(e))}}class Er extends xr{}class Lr extends ${}class zr extends Lr{}class Ir extends Lr{async _call(e){return new Ml(await super._call(e))}}class Br extends ${}class Nr extends Br{}class Or extends Br{async _call(e){return new Ml(await super._call(e))}}class jr extends ${}class Dr extends jr{}class Vr extends jr{async _call(e){return new Ml(await super._call(e))}}class Rr extends ${}class Gr extends Rr{}class $r extends Rr{async _call(e){return new Ml(await super._call(e))}}class qr extends ${}class Ur extends qr{}class Wr extends qr{}class Xr extends ${}class Qr extends Xr{}class Hr extends Xr{}class Yr extends ${}class Jr extends Yr{}class Kr extends ${}class Zr extends Kr{}class eo extends Kr{}class to extends Kr{}class no extends ${}class so extends no{}class ro extends ${}class oo extends ro{}class io extends ro{}class ao extends ${}class lo extends ao{}class co extends ao{}class uo extends ${}class po extends uo{}class ho extends ${}class _o extends ho{}class mo extends ho{async _call(e){return new Ml(await super._call(e))}}class fo extends ${}class go extends fo{}class wo extends fo{async _call(e){return new Ml(await super._call(e))}}class Mo extends ${}class bo extends Mo{}class yo extends Mo{async _call(e){return new Ml(await super._call(e))}}class xo extends ${}class ko extends xo{}class To extends xo{async _call(e){return new vo(await super._call(e))}}class vo extends q{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class Fo extends ${}class Co extends Fo{async get_image_embeddings({pixel_values:e}){return await O(this,{pixel_values:e})}async forward(e){if(e.image_embeddings&&e.image_positional_embeddings||(e={...e,...await this.get_image_embeddings(e)}),!e.input_labels&&e.input_points){const t=e.input_points.dims.slice(0,-1),n=t.reduce(((e,t)=>e*t),1);e.input_labels=new p.Tensor("int64",new BigInt64Array(n).fill(1n),t)}const t={image_embeddings:e.image_embeddings,image_positional_embeddings:e.image_positional_embeddings};return e.input_points&&(t.input_points=e.input_points),e.input_labels&&(t.input_labels=e.input_labels),e.input_boxes&&(t.input_boxes=e.input_boxes),await L(this.sessions.prompt_encoder_mask_decoder,t)}async _call(e){return new Po(await super._call(e))}}class Po extends q{constructor({iou_scores:e,pred_masks:t}){super(),this.iou_scores=e,this.pred_masks=t}}class So extends ${}class Ao extends So{}class Eo extends So{}class Lo extends ${}class zo extends Lo{}class Io extends Lo{}class Bo extends ${}class No extends Bo{}class Oo extends Bo{async _call(e){return new Tl(await super._call(e))}}class jo extends Bo{async _call(e){return new Ml(await super._call(e))}}class Do extends Bo{async _call(e){return new yl(await super._call(e))}}class Vo extends ${}class Ro extends Vo{}class Go extends Vo{async _call(e){return new yl(await super._call(e))}}class $o extends ${}class qo extends $o{}class Uo extends ${}class Wo extends Uo{}class Xo extends Uo{async _call(e){return new Tl(await super._call(e))}}class Qo extends Uo{async _call(e){return new Ml(await super._call(e))}}class Ho extends ${}class Yo extends Ho{}class Jo extends Ho{async _call(e){return new Tl(await super._call(e))}}class Ko extends Ho{async _call(e){return new Ml(await super._call(e))}}class Zo extends Ho{async _call(e){return new yl(await super._call(e))}}class ei extends ${}class ti extends ei{}class ni extends ei{async _call(e){return new Tl(await super._call(e))}}class si extends ei{async _call(e){return new Ml(await super._call(e))}}class ri extends ${}class oi extends Bo{}class ii extends Bo{async _call(e){return new Tl(await super._call(e))}}class ai extends Bo{async _call(e){return new Ml(await super._call(e))}}class li extends ${}class ci extends li{}class di extends li{async _call(e){return new Tl(await super._call(e))}}class ui extends li{async _call(e){return new Ml(await super._call(e))}}class pi extends li{async _call(e){return new bl(await super._call(e))}}class hi extends li{async _call(e){return new yl(await super._call(e))}}class _i extends ${}class mi extends _i{}class fi extends _i{}class gi extends _i{async generate_speech(e,t,{threshold:n=.5,minlenratio:s=0,maxlenratio:r=20,vocoder:o=null}={}){const i={input_ids:e},{encoder_outputs:a,encoder_attention_mask:l}=await O(this,i),c=a.dims[1]/this.config.reduction_factor,d=Math.floor(c*r),u=Math.floor(c*s),h=this.config.num_mel_bins;let _=[],m=null,f=null,g=0;for(;;){++g;const e=B(!!f);let s;s=f?f.output_sequence_out:new p.Tensor("float32",new Float32Array(h),[1,1,h]);let r={use_cache_branch:e,output_sequence:s,encoder_attention_mask:l,speaker_embeddings:t,encoder_hidden_states:a};this.addPastKeyValues(r,m),f=await L(this.sessions.decoder_model_merged,r),m=this.getPastKeyValues(f,m);const{prob:o,spectrum:i}=f;if(_.push(i),g>=u&&(Array.from(o.data).filter((e=>e>=n)).length>0||g>=d))break}const w=(0,p.cat)(_),{waveform:M}=await L(o.sessions.model,{spectrogram:w});return{spectrogram:w,waveform:M}}}class wi extends ${main_input_name="spectrogram"}class Mi extends ${}class bi extends Mi{}class yi extends ${}class xi extends yi{}class ki extends yi{}class Ti extends ${}class vi extends Ti{}class Fi extends Ti{}class Ci extends ${}class Pi extends Ci{}class Si extends Ci{}class Ai extends ${}class Ei extends Ai{}class Li extends Ai{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class zi extends Ai{static async from_pretrained(e,t={}){return t.model_file_name??="audio_model",super.from_pretrained(e,t)}}class Ii extends ${}class Bi extends Ii{async _call(e){return new Cl(await super._call(e))}}class Ni extends ${}class Oi extends Ni{}class ji extends Ni{}class Di extends Ni{}class Vi extends ${}class Ri extends Vi{}class Gi extends Vi{}class $i extends ${}class qi extends $i{}class Ui extends $i{async _call(e){return new Ml(await super._call(e))}}class Wi extends ${}class Xi extends Wi{}class Qi extends Wi{}class Hi extends ${forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"];_apply_and_filter_by_delay_pattern_mask(e){const[t,n]=e.dims,s=this.config.decoder.num_codebooks,r=n-s;let o=0;for(let t=0;t<e.size;++t){if(e.data[t]===this.config.decoder.pad_token_id)continue;const i=t%n-Math.floor(t/n)%s;i>0&&i<=r&&(e.data[o++]=e.data[t])}const i=Math.floor(t/s),a=o/(i*s);return new p.Tensor(e.type,e.data.slice(0,o),[i,s,a])}prepare_inputs_for_generation(e,t,n){let s=structuredClone(e);for(let e=0;e<s.length;++e)for(let t=0;t<s[e].length;++t)e%this.config.decoder.num_codebooks>=t&&(s[e][t]=BigInt(this.config.decoder.pad_token_id));null!==n.guidance_scale&&n.guidance_scale>1&&(s=s.concat(s));return super.prepare_inputs_for_generation(s,t,n)}async generate(e){const t=await super.generate(e),n=this._apply_and_filter_by_delay_pattern_mask(t).unsqueeze_(0),{audio_values:s}=await L(this.sessions.encodec_decode,{audio_codes:n});return s}}class Yi extends ${}class Ji extends Yi{}class Ki extends Yi{async _call(e){return new Ml(await super._call(e))}}class Zi extends ${}class ea extends Zi{}class ta extends Zi{async _call(e){return new Ml(await super._call(e))}}class na extends ${}class sa extends na{}class ra extends na{async _call(e){return new Ml(await super._call(e))}}class oa extends ${}class ia extends oa{}class aa extends oa{async _call(e){return new Ml(await super._call(e))}}class la extends ${}class ca extends la{}class da{static MODEL_CLASS_MAPPINGS=null;static BASE_IF_FAIL=!1;static async from_pretrained(e,{progress_callback:t=null,config:n=null,cache_dir:r=null,local_files_only:o=!1,revision:i="main",model_file_name:a=null,subfolder:l="onnx",device:c=null,dtype:d=null,use_external_data_format:u=null,session_options:p={}}={}){const h={progress_callback:t,config:n,cache_dir:r,local_files_only:o,revision:i,model_file_name:a,subfolder:l,device:c,dtype:d,use_external_data_format:u,session_options:p};if(h.config=await s.AutoConfig.from_pretrained(e,h),!this.MODEL_CLASS_MAPPINGS)throw new Error("`MODEL_CLASS_MAPPINGS` not implemented for this type of `AutoClass`: "+this.name);for(const t of this.MODEL_CLASS_MAPPINGS){const n=t.get(h.config.model_type);if(n)return await n[1].from_pretrained(e,h)}if(this.BASE_IF_FAIL)return console.warn(`Unknown model class "${h.config.model_type}", attempting to construct from base class.`),await $.from_pretrained(e,h);throw Error(`Unsupported model type: ${h.config.model_type}`)}}const ua=new Map([["bert",["BertModel",X]],["nomic_bert",["NomicBertModel",Z]],["roformer",["RoFormerModel",te]],["electra",["ElectraModel",he]],["esm",["EsmModel",$e]],["convbert",["ConvBertModel",ae]],["camembert",["CamembertModel",Me]],["deberta",["DebertaModel",ve]],["deberta-v2",["DebertaV2Model",Ee]],["mpnet",["MPNetModel",Ze]],["albert",["AlbertModel",dt]],["distilbert",["DistilBertModel",Oe]],["roberta",["RobertaModel",Dt]],["xlm",["XLMModel",Ut]],["xlm-roberta",["XLMRobertaModel",Jt]],["clap",["ClapModel",Ei]],["clip",["CLIPModel",fn]],["clipseg",["CLIPSegModel",Pn]],["chinese_clip",["ChineseCLIPModel",Fn]],["siglip",["SiglipModel",xn]],["mobilebert",["MobileBertModel",Qe]],["squeezebert",["SqueezeBertModel",ot]],["wav2vec2",["Wav2Vec2Model",No]],["wav2vec2-bert",["Wav2Vec2BertModel",ti]],["unispeech",["UniSpeechModel",Wo]],["unispeech-sat",["UniSpeechSatModel",Yo]],["hubert",["HubertModel",oi]],["wavlm",["WavLMModel",ci]],["audio-spectrogram-transformer",["ASTModel",sn]],["vits",["VitsModel",Bi]],["pyannote",["PyAnnoteModel",Ro]],["wespeaker-resnet",["WeSpeakerResNetModel",qo]],["detr",["DetrModel",Mr]],["rt_detr",["RTDetrModel",vr]],["table-transformer",["TableTransformerModel",Sr]],["vit",["ViTModel",Vs]],["pvt",["PvtModel",$s]],["vit_msn",["ViTMSNModel",Qs]],["vit_mae",["ViTMAEModel",Ws]],["groupvit",["GroupViTModel",Js]],["fastvit",["FastViTModel",Zs]],["mobilevit",["MobileViTModel",rr]],["mobilevitv2",["MobileViTV2Model",ar]],["owlvit",["OwlViTModel",dr]],["owlv2",["Owlv2Model",hr]],["beit",["BeitModel",fr]],["deit",["DeiTModel",zr]],["hiera",["HieraModel",Nr]],["convnext",["ConvNextModel",_o]],["convnextv2",["ConvNextV2Model",go]],["dinov2",["Dinov2Model",bo]],["resnet",["ResNetModel",Dr]],["swin",["SwinModel",Gr]],["swin2sr",["Swin2SRModel",Ur]],["donut-swin",["DonutSwinModel",po]],["yolos",["YolosModel",ko]],["dpt",["DPTModel",Qr]],["glpn",["GLPNModel",lo]],["hifigan",["SpeechT5HifiGan",wi]],["efficientnet",["EfficientNetModel",qi]],["decision_transformer",["DecisionTransformerModel",ca]],["mobilenet_v1",["MobileNetV1Model",Ji]],["mobilenet_v2",["MobileNetV2Model",ea]],["mobilenet_v3",["MobileNetV3Model",sa]],["mobilenet_v4",["MobileNetV4Model",ia]],["maskformer",["MaskFormerModel",oo]]]),pa=new Map([["t5",["T5Model",mt]],["longt5",["LongT5Model",wt]],["mt5",["MT5Model",yt]],["bart",["BartModel",Tt]],["mbart",["MBartModel",Pt]],["marian",["MarianModel",Ao]],["whisper",["WhisperModel",an]],["m2m_100",["M2M100Model",zo]],["blenderbot",["BlenderbotModel",zt]],["blenderbot-small",["BlenderbotSmallModel",Nt]]]),ha=new Map([["bloom",["BloomModel",Es]],["jais",["JAISModel",In]],["gpt2",["GPT2Model",En]],["gptj",["GPTJModel",$n]],["gpt_bigcode",["GPTBigCodeModel",Wn]],["gpt_neo",["GPTNeoModel",On]],["gpt_neox",["GPTNeoXModel",Vn]],["codegen",["CodeGenModel",Hn]],["llama",["LlamaModel",Kn]],["olmo",["OlmoModel",rs]],["mobilellm",["MobileLLMModel",ts]],["granite",["GraniteModel",as]],["cohere",["CohereModel",ds]],["gemma",["GemmaModel",hs]],["gemma2",["Gemma2Model",fs]],["openelm",["OpenELMModel",Ms]],["qwen2",["Qwen2Model",xs]],["phi",["PhiModel",vs]],["phi3",["Phi3Model",Ps]],["mpt",["MptModel",Is]],["opt",["OPTModel",Os]],["mistral",["MistralModel",xi]],["starcoder2",["Starcoder2Model",vi]],["falcon",["FalconModel",Pi]],["stablelm",["StableLmModel",Ri]]]),_a=new Map([["speecht5",["SpeechT5ForSpeechToText",fi]],["whisper",["WhisperForConditionalGeneration",ln]]]),ma=new Map([["speecht5",["SpeechT5ForTextToSpeech",gi]]]),fa=new Map([["vits",["VitsModel",Bi]],["musicgen",["MusicgenForConditionalGeneration",Hi]]]),ga=new Map([["bert",["BertForSequenceClassification",H]],["roformer",["RoFormerForSequenceClassification",se]],["electra",["ElectraForSequenceClassification",me]],["esm",["EsmForSequenceClassification",Ue]],["convbert",["ConvBertForSequenceClassification",ce]],["camembert",["CamembertForSequenceClassification",ye]],["deberta",["DebertaForSequenceClassification",Ce]],["deberta-v2",["DebertaV2ForSequenceClassification",ze]],["mpnet",["MPNetForSequenceClassification",tt]],["albert",["AlbertForSequenceClassification",ut]],["distilbert",["DistilBertForSequenceClassification",je]],["roberta",["RobertaForSequenceClassification",Rt]],["xlm",["XLMForSequenceClassification",Xt]],["xlm-roberta",["XLMRobertaForSequenceClassification",Zt]],["bart",["BartForSequenceClassification",Ft]],["mbart",["MBartForSequenceClassification",At]],["mobilebert",["MobileBertForSequenceClassification",Ye]],["squeezebert",["SqueezeBertForSequenceClassification",at]]]),wa=new Map([["bert",["BertForTokenClassification",Y]],["roformer",["RoFormerForTokenClassification",re]],["electra",["ElectraForTokenClassification",fe]],["esm",["EsmForTokenClassification",We]],["convbert",["ConvBertForTokenClassification",de]],["camembert",["CamembertForTokenClassification",xe]],["deberta",["DebertaForTokenClassification",Pe]],["deberta-v2",["DebertaV2ForTokenClassification",Ie]],["mpnet",["MPNetForTokenClassification",nt]],["distilbert",["DistilBertForTokenClassification",De]],["roberta",["RobertaForTokenClassification",Gt]],["xlm",["XLMForTokenClassification",Qt]],["xlm-roberta",["XLMRobertaForTokenClassification",en]]]),Ma=new Map([["t5",["T5ForConditionalGeneration",ft]],["longt5",["LongT5ForConditionalGeneration",Mt]],["mt5",["MT5ForConditionalGeneration",xt]],["bart",["BartForConditionalGeneration",vt]],["mbart",["MBartForConditionalGeneration",St]],["marian",["MarianMTModel",Eo]],["m2m_100",["M2M100ForConditionalGeneration",Io]],["blenderbot",["BlenderbotForConditionalGeneration",It]],["blenderbot-small",["BlenderbotSmallForConditionalGeneration",Ot]]]),ba=new Map([["bloom",["BloomForCausalLM",Ls]],["gpt2",["GPT2LMHeadModel",Ln]],["jais",["JAISLMHeadModel",Bn]],["gptj",["GPTJForCausalLM",qn]],["gpt_bigcode",["GPTBigCodeForCausalLM",Xn]],["gpt_neo",["GPTNeoForCausalLM",jn]],["gpt_neox",["GPTNeoXForCausalLM",Rn]],["codegen",["CodeGenForCausalLM",Yn]],["llama",["LlamaForCausalLM",Zn]],["olmo",["OlmoForCausalLM",os]],["mobilellm",["MobileLLMForCausalLM",ns]],["granite",["GraniteForCausalLM",ls]],["cohere",["CohereForCausalLM",us]],["gemma",["GemmaForCausalLM",_s]],["gemma2",["Gemma2ForCausalLM",gs]],["openelm",["OpenELMForCausalLM",bs]],["qwen2",["Qwen2ForCausalLM",ks]],["phi",["PhiForCausalLM",Fs]],["phi3",["Phi3ForCausalLM",Ss]],["mpt",["MptForCausalLM",Bs]],["opt",["OPTForCausalLM",js]],["mbart",["MBartForCausalLM",Et]],["mistral",["MistralForCausalLM",ki]],["starcoder2",["Starcoder2ForCausalLM",Fi]],["falcon",["FalconForCausalLM",Si]],["trocr",["TrOCRForCausalLM",bi]],["stablelm",["StableLmForCausalLM",Gi]]]),ya=new Map([["bert",["BertForMaskedLM",Q]],["roformer",["RoFormerForMaskedLM",ne]],["electra",["ElectraForMaskedLM",_e]],["esm",["EsmForMaskedLM",qe]],["convbert",["ConvBertForMaskedLM",le]],["camembert",["CamembertForMaskedLM",be]],["deberta",["DebertaForMaskedLM",Fe]],["deberta-v2",["DebertaV2ForMaskedLM",Le]],["mpnet",["MPNetForMaskedLM",et]],["albert",["AlbertForMaskedLM",ht]],["distilbert",["DistilBertForMaskedLM",Re]],["roberta",["RobertaForMaskedLM",Vt]],["xlm",["XLMWithLMHeadModel",Wt]],["xlm-roberta",["XLMRobertaForMaskedLM",Kt]],["mobilebert",["MobileBertForMaskedLM",He]],["squeezebert",["SqueezeBertForMaskedLM",it]]]),xa=new Map([["bert",["BertForQuestionAnswering",J]],["roformer",["RoFormerForQuestionAnswering",oe]],["electra",["ElectraForQuestionAnswering",ge]],["convbert",["ConvBertForQuestionAnswering",ue]],["camembert",["CamembertForQuestionAnswering",ke]],["deberta",["DebertaForQuestionAnswering",Se]],["deberta-v2",["DebertaV2ForQuestionAnswering",Be]],["mpnet",["MPNetForQuestionAnswering",st]],["albert",["AlbertForQuestionAnswering",pt]],["distilbert",["DistilBertForQuestionAnswering",Ve]],["roberta",["RobertaForQuestionAnswering",$t]],["xlm",["XLMForQuestionAnswering",Ht]],["xlm-roberta",["XLMRobertaForQuestionAnswering",tn]],["mobilebert",["MobileBertForQuestionAnswering",Je]],["squeezebert",["SqueezeBertForQuestionAnswering",lt]]]),ka=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",cn]]]),Ta=new Map([["llava",["LlavaForConditionalGeneration",un]],["moondream1",["Moondream1ForConditionalGeneration",pn]],["florence2",["Florence2ForConditionalGeneration",_n]]]),va=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",cn]]]),Fa=new Map([["vit",["ViTForImageClassification",Rs]],["pvt",["PvtForImageClassification",qs]],["vit_msn",["ViTMSNForImageClassification",Hs]],["fastvit",["FastViTForImageClassification",er]],["mobilevit",["MobileViTForImageClassification",or]],["mobilevitv2",["MobileViTV2ForImageClassification",lr]],["beit",["BeitForImageClassification",gr]],["deit",["DeiTForImageClassification",Ir]],["hiera",["HieraForImageClassification",Or]],["convnext",["ConvNextForImageClassification",mo]],["convnextv2",["ConvNextV2ForImageClassification",wo]],["dinov2",["Dinov2ForImageClassification",yo]],["resnet",["ResNetForImageClassification",Vr]],["swin",["SwinForImageClassification",$r]],["segformer",["SegformerForImageClassification",ji]],["efficientnet",["EfficientNetForImageClassification",Ui]],["mobilenet_v1",["MobileNetV1ForImageClassification",Ki]],["mobilenet_v2",["MobileNetV2ForImageClassification",ta]],["mobilenet_v3",["MobileNetV3ForImageClassification",ra]],["mobilenet_v4",["MobileNetV4ForImageClassification",aa]]]),Ca=new Map([["detr",["DetrForObjectDetection",br]],["rt_detr",["RTDetrForObjectDetection",Fr]],["table-transformer",["TableTransformerForObjectDetection",Ar]],["yolos",["YolosForObjectDetection",To]]]),Pa=new Map([["owlvit",["OwlViTForObjectDetection",ur]],["owlv2",["Owlv2ForObjectDetection",_r]]]),Sa=new Map([["detr",["DetrForSegmentation",yr]],["clipseg",["CLIPSegForImageSegmentation",Sn]]]),Aa=new Map([["segformer",["SegformerForSemanticSegmentation",Di]],["sapiens",["SapiensForSemanticSegmentation",Zr]]]),Ea=new Map([["detr",["DetrForSegmentation",yr]],["maskformer",["MaskFormerForInstanceSegmentation",io]]]),La=new Map([["sam",["SamModel",Co]]]),za=new Map([["wav2vec2",["Wav2Vec2ForCTC",Oo]],["wav2vec2-bert",["Wav2Vec2BertForCTC",ni]],["unispeech",["UniSpeechForCTC",Xo]],["unispeech-sat",["UniSpeechSatForCTC",Jo]],["wavlm",["WavLMForCTC",di]],["hubert",["HubertForCTC",ii]]]),Ia=new Map([["wav2vec2",["Wav2Vec2ForSequenceClassification",jo]],["wav2vec2-bert",["Wav2Vec2BertForSequenceClassification",si]],["unispeech",["UniSpeechForSequenceClassification",Qo]],["unispeech-sat",["UniSpeechSatForSequenceClassification",Ko]],["wavlm",["WavLMForSequenceClassification",ui]],["hubert",["HubertForSequenceClassification",ai]],["audio-spectrogram-transformer",["ASTForAudioClassification",rn]]]),Ba=new Map([["wavlm",["WavLMForXVector",pi]]]),Na=new Map([["unispeech-sat",["UniSpeechSatForAudioFrameClassification",Zo]],["wavlm",["WavLMForAudioFrameClassification",hi]],["wav2vec2",["Wav2Vec2ForAudioFrameClassification",Do]],["pyannote",["PyAnnoteForAudioFrameClassification",Go]]]),Oa=new Map([["vitmatte",["VitMatteForImageMatting",nr]]]),ja=new Map([["swin2sr",["Swin2SRForImageSuperResolution",Wr]]]),Da=new Map([["dpt",["DPTForDepthEstimation",Hr]],["depth_anything",["DepthAnythingForDepthEstimation",Jr]],["glpn",["GLPNForDepthEstimation",co]],["sapiens",["SapiensForDepthEstimation",eo]],["depth_pro",["DepthProForDepthEstimation",so]]]),Va=new Map([["sapiens",["SapiensForNormalEstimation",to]]]),Ra=new Map([["clip",["CLIPVisionModelWithProjection",bn]],["siglip",["SiglipVisionModel",Tn]]]),Ga=[[ua,M],[pa,b],[ha,k],[ga,M],[wa,M],[Ma,y],[_a,y],[ba,k],[ya,M],[xa,M],[ka,x],[Ta,v],[Fa,M],[Sa,M],[Ea,M],[Aa,M],[Oa,M],[ja,M],[Da,M],[Va,M],[Ca,M],[Pa,M],[La,T],[za,M],[Ia,M],[ma,y],[fa,M],[Ba,M],[Na,M],[Ra,M]];for(const[e,t]of Ga)for(const[n,s]of e.values())C.set(n,t),S.set(s,n),P.set(n,s);const $a=[["MusicgenForConditionalGeneration",Hi,F],["CLIPTextModelWithProjection",wn,M],["SiglipTextModel",kn,M],["ClapTextModelWithProjection",Li,M],["ClapAudioModelWithProjection",zi,M]];for(const[e,t,n]of $a)C.set(e,n),S.set(t,e),P.set(e,t);class qa extends da{static MODEL_CLASS_MAPPINGS=Ga.map((e=>e[0]));static BASE_IF_FAIL=!0}class Ua extends da{static MODEL_CLASS_MAPPINGS=[ga]}class Wa extends da{static MODEL_CLASS_MAPPINGS=[wa]}class Xa extends da{static MODEL_CLASS_MAPPINGS=[Ma]}class Qa extends da{static MODEL_CLASS_MAPPINGS=[_a]}class Ha extends da{static MODEL_CLASS_MAPPINGS=[ma]}class Ya extends da{static MODEL_CLASS_MAPPINGS=[fa]}class Ja extends da{static MODEL_CLASS_MAPPINGS=[ba]}class Ka extends da{static MODEL_CLASS_MAPPINGS=[ya]}class Za extends da{static MODEL_CLASS_MAPPINGS=[xa]}class el extends da{static MODEL_CLASS_MAPPINGS=[ka]}class tl extends da{static MODEL_CLASS_MAPPINGS=[Fa]}class nl extends da{static MODEL_CLASS_MAPPINGS=[Sa]}class sl extends da{static MODEL_CLASS_MAPPINGS=[Aa]}class rl extends da{static MODEL_CLASS_MAPPINGS=[Ea]}class ol extends da{static MODEL_CLASS_MAPPINGS=[Ca]}class il extends da{static MODEL_CLASS_MAPPINGS=[Pa]}class al extends da{static MODEL_CLASS_MAPPINGS=[La]}class ll extends da{static MODEL_CLASS_MAPPINGS=[za]}class cl extends da{static MODEL_CLASS_MAPPINGS=[Ia]}class dl extends da{static MODEL_CLASS_MAPPINGS=[Ba]}class ul extends da{static MODEL_CLASS_MAPPINGS=[Na]}class pl extends da{static MODEL_CLASS_MAPPINGS=[va]}class hl extends da{static MODEL_CLASS_MAPPINGS=[Oa]}class _l extends da{static MODEL_CLASS_MAPPINGS=[ja]}class ml extends da{static MODEL_CLASS_MAPPINGS=[Da]}class fl extends da{static MODEL_CLASS_MAPPINGS=[Va]}class gl extends da{static MODEL_CLASS_MAPPINGS=[Ra]}class wl extends q{constructor({logits:e,past_key_values:t,encoder_outputs:n,decoder_attentions:s=null,cross_attentions:r=null}){super(),this.logits=e,this.past_key_values=t,this.encoder_outputs=n,this.decoder_attentions=s,this.cross_attentions=r}}class Ml extends q{constructor({logits:e}){super(),this.logits=e}}class bl extends q{constructor({logits:e,embeddings:t}){super(),this.logits=e,this.embeddings=t}}class yl extends q{constructor({logits:e}){super(),this.logits=e}}class xl extends q{constructor({logits:e}){super(),this.logits=e}}class kl extends q{constructor({start_logits:e,end_logits:t}){super(),this.start_logits=e,this.end_logits=t}}class Tl extends q{constructor({logits:e}){super(),this.logits=e}}class vl extends q{constructor({logits:e,past_key_values:t}){super(),this.logits=e,this.past_key_values=t}}class Fl extends q{constructor({alphas:e}){super(),this.alphas=e}}class Cl extends q{constructor({waveform:e,spectrogram:t}){super(),this.waveform=e,this.spectrogram=t}}},"./src/models/whisper/common_whisper.js":
/*!**********************************************!*\
